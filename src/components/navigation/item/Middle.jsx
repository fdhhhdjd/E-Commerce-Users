...
const Middle = () => {
  return (
    <div className='w-full h-[93px] bg-white shadow-inner flex justify-between items-center px-4 md:px-[100px] lg:px-[150px] xl:px-[200px] 2xl:px-[300px]'>
      ...
      {/* Search */}
      <div className='flex items-center border border-[#e1c5c5] rounded-md overflow-hidden mx-auto'>
        <div className='flex items-center h-[45px] pl-4 pr-[18px] gap-2'>
          <div className='w-5 h-5'>
            <img
              src={search}
              alt='this image search'
              className='w-full h-full cursor-pointer'
            />
          </div>
          <input
            type='text'
            className='w-[250px] lg:w-[400px] text-darkGray text-sm lg:text-[15px] font-normal leading-[21px] font-poppins focus:outline-none border-none'
            placeholder='Search'
          />
        </div>
        <div className='px-6 py-3.5 bg-greenPrimary flex items-center'>
          <span className='text-white text-sm font-semibold leading-[16.80px] font-poppins'>
            Search
          </span>
        </div>
      </div>
      ...
      <div className='flex items-center gap-2'>
        ...
        <div className='flex items-center gap-3 relative'>
          ...
          <div className='flex flex-col'>
            <span className='text-lightGray text-xs lg:text-[11px] font-normal leading-[13.20px] font-poppins'>
              Shopping cart:
            </span>
            <span className='text-darkGray text-sm font-medium leading-[14px] font-poppins'>
              $57.00
            </span>
          </div>
        </div>
